...
func TestListenLinksForAllSongs(t *testing.T) {
	...
	if spotifyURL != "https://open.spotify.com/search/Fire%20Woman%2FShe%20Sells%20The%20Cult" {
		t.Fatalf("spotify URL=%q", spotifyURL)
	}
...
func TestSetPerformanceDetailsRenderAndKeepNotes(t *testing.T) {
	...
	if !strings.Contains(setBody, "(Alex·D·133)") || !strings.Contains(setBody, "<small data-set-note>Count in</small>") {
