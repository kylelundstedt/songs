...
| P0 | [TASK-013 — offline library, search, and snapshot diagnostics](tasks/TASK-013-offline-library-search-status.md) | Build deterministic active-generation indexes and complete zero-network browse/search/status behavior without exposing writes. |
