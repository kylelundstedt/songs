...
| P0 | [TASK-011 — isolated React/Vite read-only shell](tasks/TASK-011-isolated-read-only-shell.md) | Independent V2 shell verifies TASK-010 completely without v1 worker/cache/storage collisions or any mutation path; production IndexedDB activation remains the next packet. |
